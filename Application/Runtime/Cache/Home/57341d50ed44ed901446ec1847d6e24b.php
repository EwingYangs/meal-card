...
<link rel="stylesheet" href="/Public/Home/css/common.css" type="text/css">
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2>全部结果>
			<font color="red">
			<?php $key = I('get.key'); echo '"'.$key.'"';?>
			</font>
			</h2>
			
		</div>
		<!-- 面包屑导航 end -->
<?php $_SERVER['PHP_SELF'] = iconv('gb2312','utf-8',$_SERVER['PHP_SELF']); ?>
		<!-- 左侧内容 start -->
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="filter mt10">
				<h2><a href="<?php  echo U('Search/key_search?key='.I('get.key'),'',false)?>">重置筛选条件</a> <strong>商品筛选</strong></h2>		
