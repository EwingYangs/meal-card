...
<head>
  ...
  <script type="text/javascript" src="application/views/admin/js/global.js"></script>
  <script type="text/javascript" src="application/views/admin/js/utils.js"></script>
  <script type="text/javascript" src="application/views/admin/js/transport.js"></script>
  <style type="text/css">
    ...
    .explode {background: url(application/views/admin/images/menu_minus.gif) no-repeat 0px 3px; font-weight: bold;}
    .collapse { background: url(application/views/admin/images/menu_plus.gif) no-repeat 0px 3px; font-weight: bold;}
    .menu-item { background: url(application/views/admin/images/menu_arrow.gif) no-repeat 0px 3px; font-weight: normal;}
...
<body>
  <div id="tabbar-div">
    <p>
      <span style="float:right; padding: 3px 5px;">
        <a href="javascript:toggleCollapse();"><img id="toggleImg" src="application/views/admin/images/menu_minus.gif" width="9" height="9" border="0" alt="闭合"></a>
      </span>
  ...
  <div id="main-div">
    <div id="menu-list">
      <ul id="menu-ul">
        <li class="explode" key="02_cat_and_goods" name="menu"> 快讯管理        
          <ul>
             
              <li class="menu-item"><a href="add" target="main-frame">添加快讯</a></li>
              <li class="menu-item"><a href="news" target="main-frame">快讯列表</a></li>
              
              
          </ul>
        <li class="explode" key="02_cat_and_goods" name="menu"> 用户管理
          <ul>
             
              
              <li class="menu-item"><a href="lst" target="main-frame">用户列表</a></li>
...
function toggleCollapse()
{
  ...
  collapse = !collapse;
  document.getElementById('toggleImg').src = collapse ? 'application/views/admin/images/menu_minus.gif' : 'application/views/admin/images/menu_plus.gif';
