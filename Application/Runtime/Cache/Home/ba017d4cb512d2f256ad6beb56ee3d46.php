	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
					...
					<ul>
						...
						<li class="checkcode">
							...
							<input type="text"  name="captcha" />
							 <img id="img_check" style="cursor:pointer;" onclick="this.src='<?php echo U('verifyImg');?>#'+Math.random();" src="<?php echo U('verifyImg'); ?>" />
							<span>看不清？<a href="javascript:void(0)" onclick="document.getElementById('img_check').src='<?php echo U('verifyImg');?>#'+Math.random();">换一张</a></span>
						</li>
						<li>
							<label for="">&nbsp;</label>
			...
			<div class="guide fl">
				...
				<a href="<?php echo U('Member/register')?>" class="reg_btn">免费注册 >></a>
			</div>
